    ...
    <div className="min-h-screen space-y-6 md:space-y-10 pb-20">
      ...
      <div className="flex flex-col md:flex-row md:items-center justify-between gap-6 px-4 md:px-0">
        <div className="space-y-1">
            <h2 className="text-2xl md:text-3xl font-black text-slate-900 tracking-tight italic uppercase">Daily Attendance</h2>
      ...
      <div className="grid grid-cols-1 sm:grid-cols-3 gap-4 md:gap-8 px-4 md:px-0">
        ...
        <div className="bg-slate-900 rounded-lg p-6 md:p-8 text-white shadow-xl shadow-slate-200 relative overflow-hidden group">
          ...
          <div className="flex items-baseline gap-1">
              <h3 className={`text-4xl md:text-5xl font-black ${attendancePercentage >= 75 ? "text-emerald-400" : "text-rose-400"}`}>
