    ...
    <div className="bg-white rounded-[10px] border border-slate-100 shadow-xl shadow-slate-100/40 p-6 md:p-8 flex flex-col group transition-all duration-300 animate-in fade-in zoom-in-95">
        ...
        <div className="mt-4">
            <a 
                ...
                className="w-full py-4 bg-slate-900 border border-slate-800 text-white rounded-[10px] text-[10px] font-black uppercase tracking-[0.2em] italic shadow-xl hover:bg-indigo-600 hover:shadow-indigo-100 transition-all flex items-center justify-center gap-3"
            >
