...
const ModelPaperTable = ({ data, onEdit, onDelete }) => {
  return (
    <div className="bg-white rounded-[10px] border border-slate-100 shadow-xl shadow-slate-100/30 overflow-hidden">
      <div className="overflow-x-auto">
        <table className="w-full text-left border-collapse">
          <thead>
            <tr className="bg-white border border-slate-100 border-b border-slate-100">
