    ...
    <div className="space-y-6 relative">
      ...
      {isDeleteModalOpen && (
        <div className="fixed inset-0 z-[100] flex items-center justify-center p-4 bg-slate-900/60 backdrop-blur-sm animate-in fade-in duration-200">
          <div className="bg-white w-full max-w-md rounded-lg shadow-2xl overflow-hidden animate-in zoom-in-95 duration-300">
            <div className="p-8 text-center">
              ...
              <div className="flex gap-4">
                ...
                <button 
                  ...
                  className="flex-1 px-6 py-3 bg-red-500 text-white font-bold uppercase tracking-widest text-[11px] rounded-lg hover:bg-red-600 transition-all shadow-lg shadow-red-500/20"
                >
                  Confirm Delete
                </button>
              </div>
            ...
            <button 
              onClick={() => setIsDeleteModalOpen(false)}
              className="absolute top-4 right-4 p-2 text-gray-400 hover:text-gray-900 hover:bg-white rounded-lg transition-all"
            >
              <FiX size={20} />
            </button>
          </div>
      ...
      <div className="flex flex-col md:flex-row md:items-center justify-between gap-4 bg-white p-6 rounded-lg shadow-sm border border-slate-100 w-full">
        ...
        <div className="flex items-center gap-3">
          ...
          <button
            ...
            className="flex items-center gap-2 bg-[#0f172a] text-white px-5 py-2.5 rounded-lg font-semibold text-sm hover:bg-slate-800 transition-all shadow-lg shadow-slate-200 active:scale-95"
          >
            <FiUserPlus size={18} />
          ...
          <table className="w-full text-left border-collapse">
            ...
            <tbody className="divide-y divide-gray-50">
              {currentItems.map((faculty) => (
                <tr key={faculty._id} className="hover:bg-white/50 transition-colors group">
