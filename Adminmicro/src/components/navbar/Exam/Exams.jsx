      ...
      <div className="max-w-7xl mx-auto bg-white rounded-[2rem] border border-slate-100 shadow-xl shadow-slate-100/50 overflow-hidden">
        ...
        <div className="px-8 py-6 border-b border-slate-50 bg-slate-50/30">
          <div className="flex flex-col sm:flex-row gap-4">
            <select
              className="bg-white border-2 border-slate-100 rounded-2xl px-5 py-3 text-[10px] font-black uppercase tracking-widest w-full sm:w-64 focus:ring-4 focus:ring-indigo-50 focus:border-indigo-600 outline-none transition-all cursor-pointer shadow-sm"
              value={department}
              onChange={(e) => {
            ...
            <select
              className="bg-white border-2 border-slate-100 rounded-2xl px-5 py-3 text-[10px] font-black uppercase tracking-widest w-full sm:w-64 focus:ring-4 focus:ring-indigo-50 focus:border-indigo-600 outline-none transition-all disabled:opacity-50 cursor-pointer shadow-sm"
              value={semester}
              disabled={!department}
            ...
            <tbody className="divide-y divide-slate-50">
              {filteredExams.length ? (
                  ...
                  >
                    ...
                    <td className="px-8 py-5 text-right">
                      <button
                        ...
                        className="bg-slate-900 text-white px-5 py-2 rounded-xl text-[9px] font-black uppercase tracking-widest opacity-0 group-hover:opacity-100 transition-all hover:bg-red-600 shadow-lg shadow-slate-200"
                      >
                        Purge
                      </button>
                    </td>
                ...
                <tr>
                  ...
                  >
                    <div className="w-16 h-1 bg-slate-50 rounded-full mx-auto mb-4"></div>
