        ...
        <div className="bg-white p-8 rounded-[2.5rem] border border-gray-100 shadow-sm">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-5 gap-4">
                <div className="relative group">
                    ...
                    <input type="date" className="w-full pl-14 pr-4 py-4 bg-gray-50 border border-transparent rounded-2xl text-[11px] font-black uppercase outline-none focus:bg-white focus:border-red-600 transition-all italic" value={selectedDate} onChange={(e) => setSelectedDate(e.target.value)} />
                </div>
                <div className="relative group">
                    <FiLayers className="absolute left-5 top-1/2 -translate-y-1/2 text-gray-400 pointer-events-none" />
                    <select className="w-full pl-14 pr-4 py-4 bg-gray-50 border border-transparent rounded-2xl text-[11px] font-black uppercase outline-none focus:bg-white focus:border-red-600 transition-all italic cursor-pointer" value={selectedCourse} onChange={(e) => setSelectedCourse(e.target.value)}>
                ...
                <div className="relative group">
                    ...
                    <select className="w-full pl-14 pr-4 py-4 bg-gray-50 border border-transparent rounded-2xl text-[11px] font-black uppercase outline-none focus:bg-white focus:border-red-600 transition-all italic cursor-pointer" value={selectedSemester} onChange={(e) => setSelectedSemester(e.target.value)}>
                ...
                <div className="relative group">
                    ...
                    <select className="w-full pl-14 pr-4 py-4 bg-gray-50 border border-transparent rounded-2xl text-[11px] font-black uppercase outline-none focus:bg-white focus:border-red-600 transition-all italic cursor-pointer" value={selectedSection} onChange={(e) => setSelectedSection(e.target.value)}>
                ...
                <div className="relative group">
                    ...
                    <input className="w-full pl-14 pr-4 py-4 bg-gray-50 border border-transparent rounded-2xl text-[11px] font-black uppercase outline-none focus:bg-white focus:border-red-600 transition-all italic" placeholder="SUBJECT NAME" value={selectedSubject} onChange={(e) => setSelectedSubject(e.target.value)} />
                </div>
            </div>
        </div>
          ...
          <div className="flex flex-col items-center justify-center py-20 gap-4">
            ...
            <div className="space-y-8 animate-in slide-in-from-bottom-4 duration-700">
                ...
                <div className="grid grid-cols-1 md:grid-cols-4 gap-6">
                    <div className="bg-[#111111] p-8 rounded-[2.5rem] text-white shadow-xl shadow-black/10">
                    ...
                    <div className="bg-white p-8 rounded-[2.5rem] border border-gray-100 flex items-center justify-center gap-8 shadow-sm">
                        <button onClick={() => handleMarkAll(true)} className="flex flex-col items-center gap-2 group">
                             <div className="p-4 bg-emerald-50 text-emerald-600 rounded-2xl group-hover:bg-emerald-600 group-hover:text-white transition-all shadow-sm"><FiCheckCircle size={20} /></div>
                        ...
                        <button onClick={() => handleMarkAll(false)} className="flex flex-col items-center gap-2 group">
                             <div className="p-4 bg-red-50 text-red-600 rounded-2xl group-hover:bg-red-600 group-hover:text-white transition-all shadow-sm"><FiXCircle size={20} /></div>
                ...
                <div className="bg-white p-10 rounded-[3rem] border border-gray-100 shadow-sm">
                    <div className="flex justify-between items-center mb-10 pb-6 border-b border-gray-50">
                        ...
                        <span className="text-[10px] font-black text-gray-400 uppercase italic bg-gray-50 px-4 py-2 rounded-xl">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                        {filteredStudents.map((s) => {
                            ...
                            return (
                                <div key={s.id} className="flex justify-between items-center bg-gray-50/50 p-6 rounded-3xl border border-transparent hover:border-gray-100 hover:bg-white hover:shadow-xl transition-all group">
                                    <div className="flex items-center gap-5">
                                        <div className="w-12 h-12 bg-white rounded-2xl flex items-center justify-center text-[10px] font-black text-gray-400 group-hover:bg-red-600 group-hover:text-white transition-all shadow-sm border border-gray-100">
                                            ID
                                        </div>
                                        <div>
                                    ...
                                    <button 
                                        ...
                                        className={`px-10 py-3 rounded-2xl text-[10px] font-black uppercase italic tracking-widest transition-all shadow-md ${isPresent ? 'bg-emerald-500 text-white shadow-emerald-500/20' : 'bg-red-600 text-white shadow-red-600/20'}`}
                                    >
                    ...
                    <div className="mt-16 flex justify-end">
                         <button 
                            ...
                            className="px-20 py-6 bg-[#111111] text-white rounded-[2.5rem] text-sm font-black uppercase tracking-[0.3em] italic shadow-2xl hover:bg-red-600 transition-all disabled:opacity-50 flex items-center gap-4 group"
                         >
            ...
            <div className="bg-white py-40 rounded-[3.5rem] border border-gray-100 flex flex-col items-center justify-center text-center px-10 shadow-sm border-dashed">
                 <div className="p-10 bg-gray-50 text-gray-200 rounded-[3rem] mb-8">
                    <FiUsers size={64} />
                 </div>
